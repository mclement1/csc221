...
class TestNonNumCalc(unittest.TestCase):

    def test_one(self):
        self.assertTrue(non_num_calc('sdfdssdfdsf'))

    def test_two(self):
        self.assertFalse(non_num_calc('sfdsf4fdsfdsf45'))

    def test_three(self):
        self.assertFalse(non_num_calc('fsfdsf4'))
